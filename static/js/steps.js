 ...
 *
 * 번호를 붙이는 이유: 자리마다 이름이 다르다. 화면의 버튼은 행동을 말하고
 * (「몸통 쓰기」) 오른쪽 이력은 산출물을 말한다(「장별 몸통」). 같은 일인지가
 * 안 읽혀서 "지금이 3번 할 타이밍인가 4번 할 타이밍인가" 가 늘 남았다.
 ...
 *   달리, 이것들은 누르기 전이라 받아 올 이력이 없어서 여기 적어 둔다. */
export const STEP = {pdf: 1, outline: 2, write: 3, imgprompt: 4, build: 5, export: 6};
